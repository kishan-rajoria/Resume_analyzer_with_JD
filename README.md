...
```
cd existing_repo
git remote add origin https://code.siemens.com/falcon-x-ai-team/resume-analyzer.git
git branch -M main
...
- [ ] [Set up project integrations](https://code.siemens.com/falcon-x-ai-team/resume-analyzer/-/settings/integrations)
